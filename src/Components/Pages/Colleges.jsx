...
const Colleges = () => {
    ...
    const filteredColleges = staticColleges.filter(college =>
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredColleges.map(college => (
                    <div key={college.id} className="bg-white shadow-md rounded-lg p-4">
                        ...
                        <p className="text-gray-600">Research Count: {college.researchCount}</p>
                        <button
            ...
            {filteredColleges.length === 0 && (
                <p className="text-center text-gray-500 mt-6">No colleges found matching your search.</p>
            )}
        </div>
    );
};
